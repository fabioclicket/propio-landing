          ...
          <ul className='w-full flex gap-8 py-5 px-10 justify-end items-center font-bold'>
            <a href='#pagos'>
              <li className='max-h-max cursor-pointer relative group transition-all duration-300'>
                Pagos
                <span className='inline-block absolute w-0 mx-auto group-hover:w-full h-1 rounded-3xl bg-[#E06E1B] right-0 left-0 -bottom-1 transition-all duration-300'></span>
              </li>
            </a>
            <a href='#reportes'>
              <li className='max-h-max cursor-pointer relative group transition-all duration-300'>
            ...
            <li
              ...
              className='bg-white py-2 px-8 text-[#E06E1B] rounded-3xl cursor-pointer hover:bg-[#E06E1B] hover:text-white transition-all duration-500'
            >
              Ingresar
            </li>
          </ul>
