import TengoLogo from '../assets/propio-logo.png'
import HomeImage from '../assets/propio-home-image.png'
...
function HomePage() {
  ...
  return (
    <main className='w-full min-h-screen flex flex-col lg:grid-cols-home lg:grid'>
      <div className='relative max-h-screen flex flex-col justify-center bg-[#E06E1B] p-8 pt-8 pb-20 lg:py-20 lg:pt-8 lg:px-12'>
        <div className='h-full lg:self-end my-auto grid grid-cols-1 gap-10 lg:gap-8 place-content-between'>
          ...
          <div className='self-end my-auto grid gap-8'>
            <h2 className='max-w-md text-5xl text-white font-bold font-body lg:text-6xl lg:pr-0 xl:pr-16'>
              Lleva tu <br /> negocio al siguiente nivel
            </h2>
            ...
            <a
              href='#contacto'
              className='w-44 bg-[#913D00] text-white text-lg text-center rounded-3xl font-bold font-body py-2 lg:py-3 hover:bg-white hover:text-[#E06E1B] cursor-pointer z-50 transition-colors duration-300'
            >
              Me interesa
            </a>
          </div>
        ...
        >
          <div className='w-full flex items-center justify-between'>
            <p className='w-max flex flex-col text-black font-semibold text-xl'>
              Menú
              <span className='w-full h-1 rounded-2xl bg-[#E06E1B]'></span>
            </p>
            <div
          ...
          <ul className='w-full flex flex-col gap-8 justify-start font-bold text-black mt-10'>
            ...
            <li className='bg-[#913D00] text-center py-2 px-8 text-white rounded-3xl cursor-pointer transition-all duration-500'>
              Ingresar
            </li>
          </ul>
        </aside>
